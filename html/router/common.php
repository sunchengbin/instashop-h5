...
function getFontCss($url){
    return '<style>@font-face {font-family: "iconfont";src: url("'.$url.'/css/base/fonts/iconfont.ttf?v=1489475001139") format("truetype"),url("'.$url.'/css/base/fonts/iconfont.svg?v=1489475001139#iconfont") format("svg");}</style>';
}
function getIco($url){
