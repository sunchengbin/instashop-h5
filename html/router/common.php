...
function getFontCss($url){
    return '<style>@font-face {font-family: "iconfont";src: url("'.$url.'/css/base/fonts/iconfont.ttf?v=1491316945524") format("truetype"),url("'.$url.'/css/base/fonts/iconfont.svg?v=1491316945524#iconfont") format("svg");}</style>';
}
function getIco($url){
