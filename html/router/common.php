...
function getFontCss($url){
    return '<style>@font-face {font-family: "iconfont";src: url("'.$url.'/css/base/fonts/iconfont.ttf?v=1491463211171") format("truetype"),url("'.$url.'/css/base/fonts/iconfont.svg?v=1491463211171#iconfont") format("svg");}</style>';
}
function getIco($url){
