...
<head>
    ...
    <?php
        if(isDebug()){
            echo '<link href="'.STATIC_HOST.'/css/app/orderconfirm.css?v=1491486293005" rel="stylesheet"/>';
        }else{
            echo '<link href="'.STATIC_HOST.'/css/dist/app/orderconfirm.css?v=1491486293005" rel="stylesheet"/>';
        }
     ?>
    <title>Order</title>
    <script>
...
<body data-spider="2cj9l5q4"></body>
    ...
    <?php
        if(isDebug()){
            ...
            echo '<script src="'.STATIC_HOST.'/js/app/orderconfirm.js?v=1491486293005"></script>';
        }else{
            echo '<script src="'.STATIC_HOST.'/js/dist/app/orderconfirm.js?v=1491486293005"></script>';
        }
     ?>
    <script>
