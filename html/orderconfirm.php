...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderconfirm.css?v=1483091901483" rel="stylesheet"/>
    <title>Order</title>
    <script>
        <?php
...
<body data-spider="2cj9l5q4"></body>
    ...
    <script src="<?=STATIC_HOST?>/js/app/orderconfirm.js?v=1483091901483"></script>
    <script>
