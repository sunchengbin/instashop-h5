...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderconfirm.css?v=1470812462883" rel="stylesheet"/>
    <title>Order</title>
    <script>
        <?php
...
<body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderconfirm.js?v=1470812462883"></script>
    <script>
