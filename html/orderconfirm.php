...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderconfirm.css?v=1480508172329" rel="stylesheet"/>
    <title>Order</title>
    <script>
        <?php
...
<body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderconfirm.js?v=1480508172329"></script>
    <script>
