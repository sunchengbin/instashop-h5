...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderconfirm.css?v=1482144967692" rel="stylesheet"/>
    <title>Order</title>
    <script>
        <?php
...
<body data-spider="2cj9l5q4">
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderconfirm.js?v=1482144967692"></script>
    <script>
