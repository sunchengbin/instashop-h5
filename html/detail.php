...
<head>
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black"/>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
  <link href="<?=STATIC_HOST?>/css/dist/app/item.css?v=1476084120652" rel="stylesheet"/>
    <?php
...
<body>
    ...
    <!--<script src="<?=STATIC_HOST?>/js/base/require-config.js?v=1476084120652"></script>-->
    <script src="<?=STATIC_HOST?>/js/dist/app/item.js?v=1476084120652"></script>
    <script>
