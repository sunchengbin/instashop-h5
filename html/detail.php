...
<body>
    <script src="<?=STATIC_HOST?>/js/base/require-zepto.js?v=1467692192567"></script>
    <!--<script src="<?=STATIC_HOST?>/js/base/require-config.js?v=1467692192567"></script>-->
    <script src="<?=STATIC_HOST?>/js/dist/app/item.js?v=1467692192567"></script>
    <script>
