...
<head>
    ...
    <link href="<?=STATIC_HOST?>/css/dist/app/orderdetail.css?v=1466475629618" rel="stylesheet"/>
    <title>订单详情</title>
    <script>
        <?php
...
<body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderdetail.js?v=1466475629618"></script>
</body>
</html>