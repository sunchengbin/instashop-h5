...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderdetail.css?v=1481627786763" rel="stylesheet"/>
...
<body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderdetail.js?v=1481627786763"></script>
    <script>
