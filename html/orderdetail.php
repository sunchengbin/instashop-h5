...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderdetail.css?v=1469590318898" rel="stylesheet"/>
...
<body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderdetail.js?v=1469590318898"></script>
    <script>
