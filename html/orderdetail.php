...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/orderdetail.css?v=1491572255486" rel="stylesheet"/>
...
<body data-spider="wqk2d63u"></body>
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/orderdetail.js?v=1491572255486"></script>
    <script>
