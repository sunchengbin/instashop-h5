...
<section class="">
    ...
    {$DATA.express_free eq 0}
        {*不包邮*}
        {if $DATA.express_free_list.list|testExpress}
    ...
    <div class="list-box" data-spider="list-box">
        <div class="shop-info clearfix">
            <img src="{$DATA.shop_info.logo}">
            <p>{$DATA.shop_info.name}</p>
        </div>
        ...
        <div class="reduc-info b-bottom">
            <p class="clearfix"><span class="fr j_reduc_price">-Rp {$DATA.price.discount_price}</span>Potongan Harga: </p>
        </div>
        {/if}
        <div class="order-info">
            <p class="clearfix"><span class="fr j_post">Rp 0</span>Biaya Pengiriman: </p>
            <p class="clearfix"><span class="fr j_sum" data-price="">Rp {$DATA.price.total_price}</span>Jumlah Total: </p>
        </div>
        {$DATA.express_free eq 0}
            {*不包邮*}
            {if $DATA.express_free_list.list|testExpress}
