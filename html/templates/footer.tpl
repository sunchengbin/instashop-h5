...
{if $IS_DEBUG}
    ...
    <script src="{$STATIC_HOST}/js/app/{$INDEX_JS_NAME}.js?v=1491467490695"></script>
{else}
    <script id="j_page_index_js" data-url="/js/dist/app/{$INDEX_JS_NAME}.js?v=1491467490695" src="{$STATIC_HOST}/js/dist/app/{$INDEX_JS_NAME}.js?v=1491467490695"></script>
{/if}
{literal}
    <script>
