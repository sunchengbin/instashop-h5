...
{if $IS_DEBUG}
    ...
    <script src="{$STATIC_HOST}/js/{$TEMP_FOLDER}app/{$INDEX_JS_NAME}.js?v=1489471091690"></script>
{else}
    <script src="{$STATIC_HOST}/js/dist/{$TEMP_FOLDER}app/{$INDEX_JS_NAME}.js?v=1489471091690"></script>
{/if}
{literal}
    <script>
