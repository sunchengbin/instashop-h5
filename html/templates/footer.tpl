...
{if $IS_DEBUG}
    ...
    <script src="{$STATIC_HOST}/js/app/{$INDEX_JS_NAME}.js?v=1489493112270"></script>
{else}
    <script id="j_page_index_js" src="{$STATIC_HOST}/js/dist/app/{$INDEX_JS_NAME}.js?v=1489493112270"></script>
{/if}
{literal}
    <script>
