...
{if $IS_DEBUG}
    ...
    <script src="{$STATIC_HOST}/js/app/{$INDEX_JS_NAME}.js?v=1491382674061"></script>
{else}
    <script id="j_page_index_js" data-url="/js/dist/app/{$INDEX_JS_NAME}.js?v=1491382674061" src="{$STATIC_HOST}/js/dist/app/{$INDEX_JS_NAME}.js?v=1491382674061"></script>
{/if}
{literal}
    <script>
