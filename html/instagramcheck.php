...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/address.css?v=1498805995251" rel="stylesheet"/>
...
<div class="address-wraper ins-wraper" data-spider="ins-wraper">
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/instagramcheck.js?v=1498805995251"></script>
    <script>
