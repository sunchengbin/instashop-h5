...
<head>
    ...
    <?=STATIC_ICO_CSS?>
    <?=STATIC_FONT_CSS?>
    <link href="<?=STATIC_HOST?>/css/dist/app/address.css?v=1494993407185" rel="stylesheet"/>
...
<div class="address-wraper ins-wraper" data-spider="ins-wraper">
    ...
    <script src="<?=STATIC_HOST?>/js/dist/app/instagramcheck.js?v=1494993407185"></script>
    <script>
