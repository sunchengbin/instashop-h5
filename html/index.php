...
<head>
  ...
  <link href="<?=STATIC_HOST?>/css/dist/app/shop_index.css?v=1466678282951" rel="stylesheet"/>
...
<body>
  ...
  <!--<script src="../js/base/require-config.js?v=1466678282951"></script>-->
  <script src="<?=STATIC_HOST?>/js/dist/app/index.js?v=1466678282951"></script>
  <script>
