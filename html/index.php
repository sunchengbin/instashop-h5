...
<head>
  ...
  <?=STATIC_FONT_CSS?>
  <link href="<?=STATIC_HOST?>/css/dist/app/shop_index.css?v=1467093856165" rel="stylesheet"/>
    <?php
...
<body>
  ...
  <!--<script src="<?=STATIC_HOST?>/js/base/require-config.js?v=1467093856165"></script>-->
  <script src="<?=STATIC_HOST?>/js/dist/app/index.js?v=1467093856165"></script>
  <script>
