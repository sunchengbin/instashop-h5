...
<head>
  ...
  <link href="<?=STATIC_HOST?>/css/dist/app/shop_index.css?v=1466734111996" rel="stylesheet"/>
...
<body>
  ...
  <!--<script src="../js/base/require-config.js?v=1466734111996"></script>-->
  <script src="<?=STATIC_HOST?>/js/dist/app/index.js?v=1466734111996"></script>
  <script>
