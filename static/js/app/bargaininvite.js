                ...
                if (_this.loginResultPackage.result) {
                    ...
                    if (_localBargainInviteStorage[init_data.bargain_invite_detail.bargain_info.id]) {
                        ...
                        Sharebargain({
                            ...
                            content: "Hi, aku lagi ikutan promo tawar iPhone 7 sampai " + "Rp " + Base.others.priceFormat(init_data.bargain_invite_detail.bargain_info.base_price) + " nih! Bantu aku tawar yuk. Klik ",
