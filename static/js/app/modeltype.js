            ...
            (function(win,dom){
                var SwitchTap = {
                    ...
                    changeId:function(tabid){
                        var _alltab = dom.querySelectorAll(".decorate-sample-panel-content")||[];
                    ...
                    switchTap:function(event,tabid){
                        ...
                        if(!!event&&event.target){
                            ...
                            ctx.changeId(_tabid);
                            event.target.className = "flex-avg decorate-sample-tab-item decorate-sample-tab-active";
                        }else{
                            ctx.changeId(tabid);
                            document.querySelectorAll(".decorate-sample-tab-item")&&(document.querySelectorAll(".decorate-sample-tab-item")[0].className= "flex-avg decorate-sample-tab-item decorate-sample-tab-active")
                        }
